...
export function ChainSelectField({
  ...
  onChange,
  disabled,
  customListItemField: _customListItemField,
  token,
}: Props) {
...
const styles = {
  base: 'w-full px-2.5 py-2 relative -top-1.5 flex items-center justify-between text-sm bg-white rounded-full border border-black outline-none transition-colors duration-500',
